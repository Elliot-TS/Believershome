...
function smoothOpenClose(el, isClosing) {
    ...
    function frame() {
        ...
        if (ellapsedTime > maxFrameCount) {
            ...
            if (isClosing && el.classList.contains("accordion-open")) {
                el.classList.remove("accordion-open");
            }
            else if (!isClosing && !el.classList.contains("accordion-open")) {
            ...
            if (isClosing && el.classList.contains("accordion-open") && height < 0) {
                el.classList.remove("accordion-open");
            }
            else if (!isClosing && !el.classList.contains("accordion-open") && height > 0) {
                el.classList.add("accordion-open");
            }
